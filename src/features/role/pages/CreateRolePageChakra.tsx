...
const CreateRolePageChakra: React.FC = () => {
  const {
    formData,
    setFormData,
    errors,
          ...
          <HStack spacing={4}>
            ...
            <VStack align="flex-start" spacing={0}>
              ...
              <Text color="whiteAlpha.900" fontSize="md">
                Thêm role mới với các privileges tương ứng
              </Text>
            </VStack>
          </HStack>
        </MotionBox>
          ...
          >
            ...
            <MotionBox variants={itemVariants} p={8} borderBottom="1px" borderColor="gray.100">
              ...
              <VStack spacing={6}>
                ...
                <FormControl isRequired isInvalid={!!errors.roleCode}>
                  ...
                  <Input
                    placeholder="Ví dụ: LAB_USER (viết hoa, dùng dấu gạch dưới)"
                  ...
                  <Text fontSize="xs" color="gray.500" mt={1}>
                    Chỉ chứa chữ cái viết hoa và dấu gạch dưới (ví dụ: ADMIN, LAB_MANAGER)
                  </Text>
                  {errors.roleCode && (
                    <Text color="red.500" fontSize="sm" mt={1}>
                      {errors.roleCode}
            ...
            <MotionBox variants={itemVariants} p={8}>
              ...
              {privilegesLoading ? (
                ...
                >
                  <Spinner size="xl" color="purple.500" mb={4} thickness="4px" />
...
export default CreateRolePageChakra;
